...
- Tags: #web #vulnerabilidad #wordpress 
---
...
> ⚠️ Se produce cuando la aplicación **no valida correctamente** las entradas del usuario utilizadas para cargar archivos.
...
Contexto: queremos instalar esta versión de 'Gwolle' que es un plugin desactualizado de WordPress que nos servirá para ejecutar un ataque **RFI** y poder derivarlo a un **RCE** ![[searchsploit.png]]
...
## 🛡️ Detalles del Aviso de Seguridad
