...
## 🛠️ Cómo identificar una SQLi con `UNION SELECT`
...
> ⚠️ Es importante destacar que este tipo de prueba **solo se debe hacer en entornos controlados o con autorización explícita**. La realización de ataques sin permiso es ilegal.
