----
- Tags: #cms #web #vulnerabilidades #reconocimiento #explotación #acceso
----------
# Definición
...
Para enumerar diferentes vectores de ataque y vulnerabilidades ([[Ejercicios/IDOR/IDOR_README]])[^2]. Podemos hacerlo a través de herramientas como [[iCloudDrive/iCloud~md~obsidian/Git/Setting_Github/Documento Hacker/Gestores de contenido (CMS) 🌐/WordPress/Wpscan]] (la cual veremos más adelante u otra como *WPSeku*, *Wordpresscan*), o realizando una enumeración manual. Para este último caso podemos seguir los siguientes pasos:
...
-  Probar a navegar a través de la URL dada, por los diferentes directorios que se pueden encontrar por defecto en WordPress.
	...
	**Nota:** Partimos desde la página principal:
	...
	![[Documento Hacker/Gestores de contenido (CMS) 🌐/WordPress/Imágenes/1_enumeracion.png]]
	...
	**Nota:** Si probamos a acceder a estar ruta `/wp-admin/` habiéndonos logueado en otra ventana previamente (a diferencia de como procedíamos en la nota anterior) la URL que vemos es esta: http://localhost:31337/wp-login.php?loggedout=true&wp_lang=en_US. En cambio si accedemos a esta URL habiendo saliéndonos de la sesión logueada y accedemos de nueva a la ruta `/wp-admin/` vemos esta otra ruta (nótese la diferencia): http://localhost:31337/wp-login.php?redirect_to=http%3A%2F%2Flocalhost%3A31337%2Fwp-admin%2F&reauth=1  
	...
	![[Documento Hacker/Gestores de contenido (CMS) 🌐/WordPress/Imágenes/3_wp_admin.png]]
...
![[ Documento Hacker/Gestores de contenido (CMS) 🌐/WordPress/Imágenes/5_prueba_user.png]]

-  Si aparece un apartado sobre el autor o algún nombre de usuario, podemos clickar en él para ver a donde nos lleva y fijarnos en cómo cambia la URL. Si lo que nos reporta sigue la estructura `?author=1`, podemos probar a navegar por otros 'ID', probamos `?author=0`, `?author=2`, etc. Toda esta informaicón se tiene que analizar con detalle, observando cambios en la página para posteriores explotaciones. Recuerde que estamos en una fase de enumeración, por lo que la clave aquí es detectar el máximo de vías potenciales de explotación.

![[Documento Hacker/Gestores de contenido (CMS) 🌐/WordPress/Imágenes/2_usuario.png]]
...
![[Documento Hacker/Gestores de contenido (CMS) 🌐/WordPress/Imágenes/4_enumeracion_0.png]]
...
**Descripción**:  
El archivo [[Documento Hacker/Gestores de contenido (CMS) 🌐/WordPress/XMLRPC|XMLRPC]] en WordPress es utilizado para permitir la comunicación remota entre WordPress y otros servicios mediante XML-RPC (Remote Procedure Call). Facilita la interacción con aplicaciones móviles, servicios de integración y otros clientes externos.
...
- [[Ejercicios/GetSimple/GetSimple_Shell_Reverse]]

## Referencias

[^1]: Para una guía sobre la instalación de un servicio de WordPress vulnerable usando Docker acuda al siguiente apartado: [[iCloudDrive/iCloud~md~obsidian/Git/Setting_Github/Documento Hacker/Gestores de contenido (CMS) 🌐/WordPress/Docker]]
[^2]: Para más información sobre este tipo de ataques [[Ejercicios/IDOR/IDOR_easy]]
[^3]: Para una guía sobre posibles soluciones y configuraciones que eviten la exposición de directorios y archivos sensibles visite el siguiente apartado: [[Documento Hacker/Gestores de contenido (CMS) 🌐/WordPress/Blue Team|Blue Team]]
